...
window.SlotMachineMod.runCodeBefore = function () {
  console.log("Adding Slot Machine Mode (v14)");
...
window.SlotMachineMod.alterSnakeCode = function (code) {
  console.log("Coding Slot Machine Mode into the game (v14)");
  ...
  // Move any fruit sitting on a bridge tile to a free non-bridge cell.
  ...
  if (code.indexOf("slot_block_key_soko_bulk") < 0) {
    smReplace(
      ...
      /e7\(a\.settings,8\)\?\(o6E\(a\.Ba,e,k,d\[e\],l,f\),e7\(a\.settings,9\)&&S4E\(a\.Aa,k\.clone\(\),a\.Ba\.keys\.length\)\):e7\(a\.settings,9\)\?\(n=d\[e\],d5E\(a\.Aa,\{pos:k\.clone\(\),prev:null,wm:!0,Lh:l,sequenceNumber:f\}\),S4E\(a\.Aa,n,a\.Ba\.keys\.length\)\):\(f4E\(a\.wa,k,void 0,l,f,!0\)/,
  ...
  if (code.indexOf("slot_r7E_win_gate") < 0) {
    smReplace(
      ...
      /if\(r7E\(this\)===0\)\{s5E\.WIN\.play\(\);this\.ub=this\.nj=!0/,
      "if(r7E(this)===0&&!(window.isSlotMachineActive&&window.isSlotMachineActive()&&(window.slot_r7E_win_gate=1))){s5E.WIN.play();this.ub=this.nj=!0"
    );
  }
  ...
  if (
    ...
    smReplace(
      "e7 twin only via pulse not sticky active",
      /if\(window\.__slotActive!=null&&b===window\.__slotActive\)return!0;if\(b===5&&window\.__slotTwinLive\)return!0;/,
      "if(window.__slotActive!=null&&b===window.__slotActive&&b!==5)return!0;if(b===5&&window.__slotTwinLive)return!0;"
    );
    smReplace(
      "e7 twin only via pulse legacy active",
  ...
  if (
    ...
    smReplace(
      ...
      "if(!r&&window.isSlotMachineActive&&window.isSlotMachineActive()&&a.ub===window.SLOT_MACHINE_MODE){if(window.__slotActive!=null&&b===window.__slotActive)return!0;"
    );
...
window.remixRenderSlotMachineModeGrid = function remixRenderSlotMachineModeGrid() {
  ...
  for (let i = 0; i < pool.length; i++) {
    ...
    cell.className =
      ...
      (on ? " lH9Ipd blender_icon_on remix-slot-mode-on" : " blender_icon");
    ...
    img.className =
      "DEvgAc blender_icon_img" +
      (on ? " FMN3L blender_icon_img_selected" : "");
    img.alt = label;
    img.draggable = false;
    const src =
